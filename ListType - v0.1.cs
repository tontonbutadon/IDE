...
namespace WithListTypeVersion1
{
    class ListTypeVersion1
    {
        ...
        static private void ShowResult(ListTypeVersion1[] data)
        {
        ...
        static private void ShowResultWithMid(ListTypeVersion1[] data)
        {
            //Console.WriteLine("First Name | Last Name  |   Age")
        ...
        public ListTypeVersion1() { }
        public ListTypeVersion1(string name_, string surname_, double result_)
        {
            this.name = name_;
            this.surname = surname_;
            this.result = result_;
        }
        public ListTypeVersion1(string name_, string surname_, double result_, double resultMid_)
        {
            this.name = name_;
            this.surname = surname_;
            this.result = result_;
        ...
        */
        static void Main(string[] args)
        {
            ...
            ListTypeVersion1[] allData = new ListTypeVersion1[count];
            while (n < count)
            {
                ...
                exam = EnterExam();
                result = Math.Round(0.3 * CalculateAvg(hws_ListTypeT.ToArray()) + 0.7 + exam, 2);
                resultMid = Math.Round(0.3 * CalculateMid(hws_ListTypeT.ToArray()) + 0.7 * exam, 2);
                allData[n] = new ListTypeVersion1(name, surname, result, resultMid);
